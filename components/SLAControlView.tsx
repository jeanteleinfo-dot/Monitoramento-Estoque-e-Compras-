...
interface SLAControlViewProps {
  projects: MultiPhaseProject[];
  onUpdateProjects: (projects: MultiPhaseProject[]) => void;
}

export const SLAControlView: React.FC<SLAControlViewProps> = ({ projects, onUpdateProjects }) => {
